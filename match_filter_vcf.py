#!/usr/bin/Miniconda3/envs/myenv/python3
# Last updated: December 28th, 2023 

# Open command palette with ctrl+shift+p
# Search for: "Python: Select Interpreter" 
# Select the conda env: "C:\Program Files\Miniconda3\envs\myenv"
# To run single lines of code, use: shift+enter
...
# # Set directores and variables 
# hg = '37' # or 38
# acmg = True # or False
# snps_only = True 
# wkdir = 'L:/LovbeskyttetMapper/ELEGANT/Data/Genotype_data/genotype_filters'
# print(f'\n# Working directory is: {wkdir}')
# print(os.listdir(wkdir))

# # Set the input vcf file to be filtered for actionable variant positions 
# input_file = 'L:/LovbeskyttetMapper/ELEGANT/Data/Genotype_data/genotype_filters/nopho2008_qc_nodupIID_test.vcf'
# # input_file = 'L:/LovbeskyttetMapper/ELEGANT/Data/Genotype_data/merged/nopho2008_qc_nodupIID_test.vcf'
# output_file = 'L:/LovbeskyttetMapper/ELEGANT/Data/Genotype_data/genotype_filters/nopho2008_qc_nodupIID_test_acmg_filtered.vcf'
# print(f'# Input vcf file is: {input_file}')

# # CHeck that the human genome reference for the filter is valid
# assert args.hg in ['37', '38', 37, 38], f'Human genome reference not valid. Expected 37 or 38, got {hg}.'
...
# 'L:/LovbeskyttetMapper/ELEGANT/Data/Reference_data/clinvar_acmg3.2_subset.txt.gz'
...
# Check that number of lines with variants match 
# kept_removed = kept+removed
# assert totalLines == kept_removed, f"Number of variants do not match! Expected {totalLines} variants, but got {kept_removed}."
